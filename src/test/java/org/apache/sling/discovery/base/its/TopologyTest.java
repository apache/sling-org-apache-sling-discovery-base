...
public class TopologyTest {
    ...
    public void testTwoNodes() throws Throwable {
        ...
        // check topology
        TopologyHelper.assertTopologyConsistsOf(
                instance1.getDiscoveryService().getTopology(), instance1.getSlingId(), instance2.getSlingId());
        TopologyHelper.assertTopologyConsistsOf(
                instance2.getDiscoveryService().getTopology(), instance1.getSlingId(), instance2.getSlingId());
        ...
        Thread.sleep(
                6000); // another sleep 6s (2.2+6 = 8.2sec) ensures instance1's heartbeat timeout (which is 8sec) hits
        // as well
        instance1LocalAnnouncements = instance1.getAnnouncementRegistry().listLocalAnnouncements();
